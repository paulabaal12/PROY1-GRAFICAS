...
impl Renderer {
    pub fn new(width: usize, height: usize) -> Self {
        let texture = Renderer::load_texture("assets/fondo.jpg");
    ...
    pub fn render_3d(&self, map: &Map, player: &Player) -> Vec<u32> {
        ...
        for x in 0..self.width {
            ...
            // Calcular el mapeo en las coordenadas u y v
            ...
            for y in 0..self.height {
                ...
                if y < wall_top {
                    ...
                    // Muestrear la textura de acuerdo a las coordenadas u y v
    ...
    pub fn render_minimap(&self, map: &Map, player: &crate::player::Player, buffer: &mut Vec<u32>) {
        ...
        let buffer_height = self.height.min(minimap_size);
    
        for dy in -1..=1 {
            for dx in -1..=1 {
                let px = player_x as i32 + dx;
                let py = player_y as i32 + dy;
                if px >= 0 && px < minimap_size as i32 && py >= 0 && py < buffer_height as i32 {
